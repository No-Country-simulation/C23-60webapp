...
const destinos = [
  ...
  },
  {
    ...
    imagen:
      "https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcTjvwOHltY1-CyWJoN0pvhzEyXU2fQQowcdZBKM95diJ9O9bTVyMmgChLE7DbTor2DFfNsijFWeO39MQeY3bF-l0wm8qlDs1lpudBlTIQ",
    precio: "$1299",
    duracion: "5 días",
      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-center max-w-2xl mx-auto">
            Descubre lugares increíbles alrededor del mundo y comienza a
            planificar tu próxima aventura con nuestra selección curada de
            destinos.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-12">
          ...
          <div className="w-full">
            {[
              {
                pregunta: "¿Cómo puedo reservar un destino?",
                respuesta:
                  "Para reservar un destino, selecciona el destino que te interese y sigue el proceso de reserva.",
              },
              {
                pregunta: "¿Qué incluyen los paquetes de viaje?",
                respuesta:
                  "Nuestros paquetes incluyen alojamiento, traslados y algunas actividades según el destino.",
              },
              {
                pregunta: "¿Cuál es la política de cancelación?",
                respuesta:
                  "Las cancelaciones varían según el destino. Generalmente, si cancelas más de 30 días antes, recibes un reembolso completo.",
              },
              {
                pregunta: "¿Ofrecen seguro de viaje?",
                respuesta:
                  "Sí, ofrecemos varias opciones de seguro que puedes agregar a tu reserva.",
              },
            ].map((item, index) => (
