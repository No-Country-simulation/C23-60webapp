...
CREATE TABLE purchase_travel_bundles
(
...
ALTER TABLE purchase_travel_bundles
    ADD CONSTRAINT fk_purchase_on_purchase FOREIGN KEY (purchase_id) REFERENCES purchase (id);

ALTER TABLE purchase_travel_bundles
    ADD CONSTRAINT fk_purchase_on_travel_bundle FOREIGN KEY (travel_bundles_id) REFERENCES travel_bundle (id);